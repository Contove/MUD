...
public class MUD
{
    ...
    public Map<String,String> onlineusers = new HashMap<String,String>();
    ...
    */
    ...
    public void addUser(String name,String loc)                 //add a user at selected location
    {
        onlineusers.put(name,loc);
        return;
    }
    public void changeUserLoc(String name,String loc)           //update user location
    {
        onlineusers.replace(name,loc);
    }
    public void removeUser(String name)                         //remove user from the list
    {
